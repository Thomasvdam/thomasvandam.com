...
This repository uses the personal [`conversation-workflow` skill](https://github.com/Thomasvdam/codex-workflow)
and `~/.local/bin/codex-workflow`. Project validation remains `./scripts/check`.
